...
- `GEMINI_SAFETY_SETTINGS`: Gemini模型[安全设置](https://ai.google.dev/api/generate-content#v1beta.HarmCategory)，使用"类别:安全模式"指定，","分隔，例如：-e GEMINI_SAFETY_SETTINGS="HARM_CATEGORY_HARASSMENT:STRICT,HARM_CATEGORY_HATE_SPEECH"，为空则使用默认配置
- `GEMINI_EXP_SAFETY_SETTINGS` : Gemini EXP模型[实验性安全设置](https://ai.google.dev/api/generate-content#v1beta.HarmCategory),使用"类别:安全模式"指定，","分隔，例如：-e GEMINI_EXP_SAFETY_SETTINGS="HARM_CATEGORY_HARASSMENT:STRICT,HARM_CATEGORY_HATE_SPEECH"，为空则使用默认配置
